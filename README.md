...
- 🔧 **Currently**: Working part-time at **ANDRITZ** as a Software Developer
- 🎯 **Focus Areas**: 
...
### 🤖 AI & Machine Learning
- **[AI Information Detection](https://github.com/Okkahai/AI-Information-Detection)** - CNN and LSTM models for information classification with React frontend
- **[Machine Learning Course](https://github.com/Okkahai/Machine-Learning)** - Comprehensive ML implementations covering regression, classification, deep learning, and more

### 🏭 Industrial & Enterprise
- **[Metris Reports](https://github.com/Okkahai/MetrisReports)** - Python library for generating interactive HTML reports from industrial process data
- **[DryerAce Calculator](https://github.com/Okkahai/DryerAce-Calculator)** - Svelte-based profit calculator with advanced analytics and visualization

### 🎮 Desktop Applications
- **[MPlayer (Spotify Clone)](https://github.com/Okkahai/MPlayer)** - Desktop music player with Spotify-inspired UI built with C# and DevExpress
- **[Reminder App](https://github.com/Okkahai/ReminderApp)** - Desktop reminder application with scheduled notifications

### 📚 Learning Projects
- **[100 Days of Python](https://github.com/Okkahai/100_Days)** - Collection of Python projects including games, simulations, and utilities
- **[C Mini Projects](https://github.com/Okkahai/C-mini-projects)** - Data structures and algorithms implementations in C
...
- 🔬 **Machine Learning**: Deep learning, neural networks, and data analysis
- 🏭 **Industrial Automation**: SCADA systems, process optimization, and reporting
...
- 🎓 Working through comprehensive Machine Learning course materials
- 🏭 Developing reporting tools for industrial process data
- 🎮 Building desktop applications with C# and .NET
- 🐍 Exploring Python for automation and data science
